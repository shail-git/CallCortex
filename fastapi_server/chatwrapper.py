...
async def acompletion_with_retry(
    ...
    **kwargs: Any,
    ...
    return await SimpleChatWrapper.completion_with_retry()
...
class SimpleChatWrapper(BaseChatModel):
    ...
    def completion_with_retry(
        ...
        content = input('response from openAI')
        role = 'assistant'
        return [{'choices': [{'delta':{'role': role, 'content': content}}]}]
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        for chunk in self.completion_with_retry(
            ...
            if not isinstance(chunk, dict): # breakpoint1
                chunk = chunk.dict()
